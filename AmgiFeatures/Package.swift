...
let package = Package(
    ...
    targets: [
        .target(
            name: "AmgiAppCore",
            dependencies: [
                .product(name: "AnkiKit", package: "amgi2"),
        ...
        .target(
            ...
            dependencies: [
                "AmgiAppCore",
                .product(name: "AnkiKit", package: "amgi2"),
                .product(name: "AnkiClients", package: "amgi2"),
                .product(name: "AnkiServices", package: "amgi2"),
        ...
        .target(
            ...
            dependencies: [
                ...
                .product(name: "AnkiClients", package: "amgi2"),
                .product(name: "AnkiServices", package: "amgi2"),
                .product(name: "AmgiCardWeb", package: "amgi2"),
                .product(name: "Dependencies", package: "swift-dependencies"),
            ],
            swiftSettings: sharedSwiftSettings
        ),
        ...
        .target(
            ...
            dependencies: [
                ...
                .product(name: "AnkiKit", package: "amgi2"),
                .product(name: "AnkiClients", package: "amgi2"),
                .product(name: "AnkiSync", package: "amgi2"),
                .product(name: "AmgiTheme", package: "AmgiUI"),
                .product(name: "AmgiUI", package: "AmgiUI"),
                .product(name: "Dependencies", package: "swift-dependencies"),
                .product(name: "Sharing", package: "swift-sharing"),
        ...
        .target(
            ...
            dependencies: [
                ...
                "TemplatesFeature",
                .product(name: "AnkiKit", package: "amgi2"),
                .product(name: "AnkiBackend", package: "amgi2"),
                .product(name: "AnkiClients", package: "amgi2"),
                .product(name: "AnkiServices", package: "amgi2"),
                .product(name: "AnkiSync", package: "amgi2"),
                .product(name: "AmgiCardWeb", package: "amgi2"),
